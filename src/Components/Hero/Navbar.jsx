...
const Header = ({ canNavigate, onRestrictedClick, sectionRefs }) => {
  ...
  const navLinks = [
    { name: "Biography", path: "/Dr.S.Rengaraj-Portfolio/BioGraphy" },
    { name: "Education", path: "/Dr.S.Rengaraj-Portfolio/Education" },
    { name: "Experience", path: "/Dr.S.Rengaraj-Portfolio/Experience" },
    { name: "Contact", path: "/Dr.S.Rengaraj-Portfolio/Contact" },
  ];
  ...
  const handleNavClick = (e, path) => {
    ...
    const scrollMap = {
      "/Dr.S.Rengaraj-Portfolio/BioGraphy": sectionRefs.bioRef,
      "/Dr.S.Rengaraj-Portfolio/Education": sectionRefs.eduRef,
      "/Dr.S.Rengaraj-Portfolio/Experience": sectionRefs.expRef,
      "/Dr.S.Rengaraj-Portfolio/Contact": sectionRefs.contactRef,
    };
            ...
            <div className="w-full px-6 flex items-center justify-between">
              ...
              <SignedOut>
                <div className="bg-white/10 backdrop-blur-md rounded-full px-6 py-3 flex items-center gap-4 shadow-md">
                  <button
                    onClick={() =>
                      navigate("/Dr.S.Rengaraj-Portfolio/?sign-in=true")
                    }
