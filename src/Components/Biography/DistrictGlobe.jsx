...
const DistrictGlobe = () => {
  ...
  const userDistrict = "Madurai";

  const districtLabels = [
    { lat: 9.9252, lng: 78.1198, text: "Madurai" },
  ...
  useEffect(() => {
    ...
    timers.push(
      setTimeout(() => {
        triggerAlert(`Born & Brought By ${userDistrict}`, 2000);
      }, 3000)
    );

    const motivationalMessages = [
      "Empowering Minds Through Commerce",
      "Knowledge. Integrity. Progress.",
      "Research-Driven Teaching, Purpose-Driven Learning.",
      "Empowering Students, Enriching Society.",
      "Guiding Minds, Growing Futures.",
    ];
